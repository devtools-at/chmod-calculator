...
<p align="center">
  <a href="https://devtools.at/tools/chmod-calculator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Calculate Unix file permissions</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/chmod-calculator">Try Online</a> •
...
**[Try Chmod Calculator online at DevTools.at →](https://devtools.at/tools/chmod-calculator)**
...
Calculate Unix file permissions. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/chmod-calculator';
